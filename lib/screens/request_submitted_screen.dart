    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(localization.theRequestSentSuccessfully,
            ...
            Column(
              children: [
                CustomButton(
                  title: localization.trackYourRequest,
                  onPress: () {
                    Navigator.pushNamed(context, ItemRequestsScreen.id);
                  },
                  buttonStyle: kDarkButtonStyle,
                ),
                CustomButton(
                  title: localization.goBackToMainScreen,
                  onPress: () {
                    Navigator.of(context).popUntil((route) => route.isFirst);
                  },
                  buttonStyle: kLightButtonStyle,
                ),
              ],
            ),
          ],
